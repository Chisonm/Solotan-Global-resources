        ...
        <div class="container py-md-3">
            <div class="cwp4-two row">
                ...
                <div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                    <img src="{{asset('assets/images/g4.jpg')}}" class="img-fluid" alt="" />
                </div>
            </div>
        </div>
    </div>
			...
			<div class="row inner-sec-w3ls-w3pvt-aminfo pt-5 mt-3">
				<div class="col-lg-3 col-sm-6">
					<div class="team-grid text-center">
						<div class="team-img">
							<img class="img-fluid rounded" src="{{asset('assets/images/t1.jpg')}}" alt="">
						</div>
						<div class="team-info">
							<h4>Trent Boult</h4>
				...
				<div class="col-lg-3 col-sm-6 top-tem">
					<div class="team-grid text-center">
						<div class="team-img">
							<img class="img-fluid rounded" src="{{asset('assets/images/t2.jpg')}}" alt="">
						</div>
						<div class="team-info">
							<h4>Henry David</h4>
							<ul class="d-flex justify-content-center py-3 social-icons">
				...
				<div class="col-lg-3 col-sm-6  mt-sm-0 mt-5">
					<div class="team-grid text-center">
						<div class="team-img">
							<img class="img-fluid rounded" src="{{asset('assets/images/t3.jpg')}}" alt="">
						</div>
						<div class="team-info">
							<h4>Jonty Rhoods</h4>
							<ul class="d-flex justify-content-center py-3 social-icons">
				...
				<div class="col-lg-3 col-sm-6 top-tem">
					<div class="team-grid text-center">
						<div class="team-img">
							<img class="img-fluid rounded" src="{{asset('assets/images/t4.jpg')}}" alt="">
						</div>
						<div class="team-info">
							<h4>Andrew Tye</h4>
							<ul class="d-flex justify-content-center py-3 social-icons">
